...
namespace Lab21.Models
{
    public class User
    {
        ...
        [RegularExpression(@"^[a-zA-Z|\s]+$", ErrorMessage = "Numbers and symbols are not allowed in a name.")]   //will this regex allow extra spaces at the beginning or end of a name?
